...
class URIphenotype(FlaskForm):
    ...
    URIphenotype = StringField('Insert the disease \'MONDO:\' URI (Monarch Initiative\'s own identifier) of the disease of interest (e.g. MONDO:0007739 for Huntington Disease) since OMIMs no longer are supported as query seeds.', validators =[DataRequired(), Length(min=5, max=20)])
