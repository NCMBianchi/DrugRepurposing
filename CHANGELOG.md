...
## [2025.1.0] - 2025-11-25
### Changed
- moved Python scripts from 'python_scripts/' to root directory
- added 'utils/' directory
- updated '.gitignore'
- added Docker source files for reproducible pipeline execution (available as release asset)

### Notes
- no functional changes to the scripts themselves
- Docker environment provided for peer-review reproducibility
