...
class user_input(FlaskForm):
    ...
    # # Docker Swarm service toggles
    # monarch_toggle = BooleanField('Monarch Service', default=True)
    # dgidb_toggle = BooleanField('DGIdb Service', default=True)
    # drugsim_toggle = BooleanField('Drug Similarity Service', default=True)
    # negsample_toggle = BooleanField('Negative Sampling Service', default=True)
    # networkmodel_toggle = BooleanField('Network Model Service', default=True)